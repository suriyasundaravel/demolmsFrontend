...
@Component({
  ...
  templateUrl: './sup-leavehistory.page.html',
  styleUrls: ['./sup-leavehistory.page.scss'],
})
export class SupLeavehistoryPage implements OnInit {
